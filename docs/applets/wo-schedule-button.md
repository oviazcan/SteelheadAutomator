...
**Ojo con `QrCode2Icon` aquí:** este applet lo usa para encontrar el disparador de impresión de etiquetas. El falso positivo del aria («Escanear Código QR» = la CÁMARA) le habría hecho abrir la cámara en vez de generar el PDF. Corregido antes de que llegara a producción; queda fijado por 2 tests de regresión con los textos reales.
