...
**Versión:** 0.7.0 — **+ 4º toggle "🏷️ Etiquetas"** (VIVO config 1.7.200, 2026-07-24): botón 🏷️ por fila en la **columna Acciones nativa** que **genera el JobTag PDF en un IFRAME OCULTO** dentro del dashboard (sin abrir pestaña → no roba foco; sin throttle → rápido) y **auto-descarga `WO<idInDomain>.pdf`**; **fallback a pestaña** si SH bloquea el enmarcado. **Validado en vivo** (operador: 4/5 en iframe, 1 cayó a pestaña bajo carga — degradó con gracia). Detalle completo en [`wo-label-pdf-buttons.md`](wo-label-pdf-buttons.md). Commit `a4bff19`.
