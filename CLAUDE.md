...
|---|---|---|
| `bulk-upload` | 1.5.8 (hot-patch anti-freeze: yield + Apollo drain periódico en prefetch + cap `_log` + Datadog stop pre-panel) (+ ext 1.6.2) | [`docs/applets/bulk-upload.md`](docs/applets/bulk-upload.md) |
