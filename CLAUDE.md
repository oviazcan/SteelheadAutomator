...
|---|---|---|
| `bulk-upload` | 1.5.14 (fix field names en preserve dims: `geometryTypeDimensionTypeId` / `dimensionValue` / `unitByUnitId.id` — el 1.5.13 rechazaba todos los nodos del PN existente y blanqueaba sus dims físicos) (+ ext 1.6.2) | [`docs/applets/bulk-upload.md`](docs/applets/bulk-upload.md) |
