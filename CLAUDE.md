...
| `spec-migrator` (bundle Ajuste Masivo) | original + `validate-duplicate-params` 0.5.2 (modo CSV multi-cliente + memory hardening) | [`docs/applets/spec-migrator.md`](docs/applets/spec-migrator.md) |
