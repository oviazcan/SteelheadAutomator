...
|---|---|---|
| `bulk-upload` | 1.5.9 (FIX CRÍTICO: `extractPNShape` guarda `customInputs` → STEP 6 preserva `QuoteIBMS`/`BaseMetal`/`DatosFacturacion`/etc en MODIFY; bug blanqueaba ~80% en diff-mode) (+ ext 1.6.2) | [`docs/applets/bulk-upload.md`](docs/applets/bulk-upload.md) |
