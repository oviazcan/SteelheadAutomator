...
|---|---|---|
| `bulk-upload` | 1.5.3 (match-by-id bypassea `classifyOnePN`: Pase 0 `idsh-direct` con `userDecided=true`) (+ ext 1.6.2) | [`docs/applets/bulk-upload.md`](docs/applets/bulk-upload.md) |
...
| `dual-source-recovery` (tool standalone, no extensión) | 1.0.1 (validador realista: _x000D_+prefix, reporte sin truncar; 12 suspicious vs 11,263) | [`docs/applets/dual-source-recovery.md`](docs/applets/dual-source-recovery.md) |
