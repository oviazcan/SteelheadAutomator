...
| `spec-migrator` (bundle Ajuste Masivo) | original + `validate-duplicate-params` 0.5.1 (modo CSV multi-cliente) | [`docs/applets/spec-migrator.md`](docs/applets/spec-migrator.md) |
